 ...
 <div class="col-xl-8 col-lg-6">
   ...
   <div class="card-body">
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
        <input type="submit" name="add_blog" 
...
if(isset($_POST['add_blog'])) {
    ...
    if(in_array($image_ext, $allow_type)){
      if($size<= 2000000){
        ...
        $sql2="INSERT INTO blog(blog_title,blog_body,blog_image,
        category,author_id) VALUES ('$title','$body','$filename',
        '$category','$author_id')";
