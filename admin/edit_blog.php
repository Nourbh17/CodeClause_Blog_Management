   ...
   <div class="card-body">
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            placeholder="Title" class="form-control" required value="<?=$result['blog_title']?>">
        </div>
        <div class="mb-3">
            <label>Body/Description</label>
            <textarea class="form-control"  name="blog_body"
            rows="2" id="blog" ><?=$result['blog_body']?></textarea>
        </div>
        <div class="mb-3">
            <input type="file" name="blog_image" 
            class="form-control"> <img src="upload/<?=$result['blog_image']
?>" width="100px" class="border">
</div>
        <div class="mb-3">
        ...
        <div class="mb-3">
        <input type="submit" name="edit_blog" 
    ...
    if(!empty($filename)){
        if(in_array($image_ext, $allow_type)){
            if($size<= 2000000){
              ...
              blog_body='$body',blog_image='$filename', 
            ...
            $msg= ['File type is not allowed (only: jpg, png and jpeg)',
            'alert-danger'];
             $_SESSION['msg']=$msg;
             header("location:index.php");
